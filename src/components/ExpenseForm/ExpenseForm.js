    ...
    return (
        <form>
            <div className="expense-form">
                ...
                <div className="form-item">
                    <label>Amount: </label>
                    <input placeholder="Amount" type="number" min="0.01" step="0.01" id="amount" onChange={amountChangeHandler}/>
                </div>
                <div className="form-item">
                    <label>Location: </label>
                    <input placeholder="Location" id="location"  onChange={locationChangeHandler}/>
                </div>
                <div className="form-item">
                    <label>Date: </label>
                    <input placeholder="Date" id="date" type="date" onChange={dateChangeHandler} />
                </div>
